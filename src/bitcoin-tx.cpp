...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " garlicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  garlicoin-tx [options] <hex-tx> [commands]  Update hex-encoded garlicoin transaction\n" +
            "or:     garlicoin-tx [options] -create [commands]   Create hex-encoded garlicoin transaction\n" +
            "\n";
