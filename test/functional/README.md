...
with the garlicoind(s) being tested in a callback-based event loop; the other
implements the test logic.

- `P2PConnection` is the class used to connect to a garlicoind.  `P2PInterface`
...
Basic code to support P2P connectivity to a garlicoind.
