...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.garlicoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.garlicointools.com");
        vSeeds.emplace_back("dnsseed.garlicoinpool.org");
        ...
        fDefauSTOPSHIPonsistencyChecks = false;
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.garlicointools.com");
        vSeeds.emplace_back("seed-b.garlicoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        fDefauSTOPSHIPonsistencyChecks = true;
        fRequireStandard = false;
