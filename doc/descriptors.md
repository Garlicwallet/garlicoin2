# Support for Output Descriptors in Garlicoin Core

Since Garlicoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `grlc1...` for mainnet or `tgrlc1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Garlicoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Garlicoin Core wallets, a convenience function `combo` is
