...
"""Verify that starting garlicoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start garlicoin with -h for help text")
        ...
        self.log.info("Start garlicoin with -version for version information")
        ...
        self.log.info("Start garlicoind with -fakearg to make sure it does not start")
